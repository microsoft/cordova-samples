...
#Angular
InstallPreReqs "www\scripts\frameworks\angular.min.js" "http://ajax.googleapis.com/ajax/libs/angularjs/1.2.15/angular.min.js" "AngularJs dependencies"
InstallPreReqs "www\scripts\frameworks\angular-resource.min.js" "http://ajax.googleapis.com/ajax/libs/angularjs/1.2.15/angular-resource.min.js" "AngularJs dependencies"
